...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pricingData = {
        mensual: {
            pertenece: { price: '45', suffix: '€/mes', total: 'Facturado mes a mes', saving: '', display: '45€/mes' },
            transforma: { price: '90', suffix: '€/mes', total: 'Facturado mes a mes', saving: '', display: '90€/mes' }
        },
        trimestral: {
            pertenece: { price: '40', suffix: '€/mes', total: '120€ cada 3 meses', saving: 'Ahorras 15€', display: '40€/mes' },
            transforma: { price: '80', suffix: '€/mes', total: '240€ cada 3 meses', saving: 'Ahorras 30€ ⭐', display: '80€/mes' }
        },
        semestral: {
            pertenece: { price: '37', suffix: '€/mes', total: '222€ cada 6 meses', saving: 'Ahorras 48€', display: '37€/mes' },
            transforma: { price: '75', suffix: '€/mes', total: '450€ cada 6 meses', saving: 'Ahorras 90€ ⭐', display: '75€/mes' }
        },
        anual: {
            pertenece: { price: '33', suffix: '€/mes', total: '396€ al año', saving: 'Ahorras 144€', display: '33€/mes' },
            transforma: { price: '67', suffix: '€/mes', total: '804€ al año', saving: 'Ahorras 276€ ⭐', display: '67€/mes' }
        }
    };
    ...
    let plazas = parseInt(localStorage.getItem('integras_plazas_restantes') || '8', 10);
